        ...
        <div>
            {registerState ? (
                <Stack spacing={2}>
                    ...
                    {passwordAlert ? <Alert severity="error">Passwords are different</Alert> : ""}
                    ...
                    <TextField id="password" label="Password" variant="standard" type="password" onChange={handleChange} value={passwordText}/>
                    <TextField id="cpassword" label="Confirtm Password" variant="standard" type="password" onChange={handleChange} value={cpasswordText}/>
                ...
                <Stack spacing={2}>
                    {alert ? <Alert severity="error">Unable to login</Alert> : ""}
                    <TextField id="login" label="Login" variant="standard" onChange={handleChange} value={loginText}/>
                    <TextField id="password" label="Password" variant="standard" type="password" onChange={handleChange} value={passwordText}/>
